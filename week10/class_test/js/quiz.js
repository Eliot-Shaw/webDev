...
function iwillnotcheat()
{
    document.getElementById("quizBegin").disabled = false;
    document.getElementById("nocheat").disabled = true;
}
...
var x = setInterval(function()
{
    ...
    if(timeLeft<5000) document.getElementById("quizTimer").style.backgroundColor = "red";
...
function quizClalculate()
{
    ...
    document.getElementById("quizResultText").textContent = "Your score is : "+score+"/3";
